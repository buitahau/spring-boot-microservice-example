package hau.bui.tutorial.microservice.currencyconversion.controller;

import hau.bui.tutorial.microservice.currencyconversion.bean.CurrencyConversionBean;
import hau.bui.tutorial.microservice.currencyconversion.proxy.CurrencyExchangeServiceProxy;
...
public class CurrencyConversionController {
	...
	public CurrencyConversionBean convertCurrencyFeign(@PathVariable String from, @PathVariable String to,
		...
		CurrencyConversionBean response = _proxy.retrieveExchangeValue(from,
						to);
